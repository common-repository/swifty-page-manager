...
if( ! class_exists( 'SwiftyApiManagerUpdateApiCheck' ) ) {
    class SwiftyApiManagerUpdateApiCheck
    {
        ...
        {
            echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %s has expired. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', 'swifty-page-manager' ) . '</p></div>', $this->product_id, $this->renew_license_url );
        }
        ...
        {
            echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %s has expired. You can reactivate the subscription from your account <a href="%s" target="_blank">dashboard</a>.', 'swifty-page-manager' ) . '</p></div>', $this->product_id, $this->renew_license_url );
        }
        ...
        {
            echo sprintf( '<div id="message" class="error"><p>' . __( 'A license key for %s could not be found. Maybe you forgot to enter a license key when setting up %s, or the key was deactivated in your account. You can reactivate or purchase a license key from your account <a href="%s" target="_blank">dashboard</a>.', 'swifty-page-manager' ) . '</p></div>', $this->product_id, $this->product_id, $this->renew_license_url );
        }
        ...
        {
            echo sprintf( '<div id="message" class="error"><p>' . __( '%s has not been activated. Go to the settings page and enter the license key and license email to activate %s.', 'swifty-page-manager' ) . '</p></div>', $this->product_id, $this->product_id );
        }
